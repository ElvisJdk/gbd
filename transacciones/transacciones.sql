...
CALL ActualizarInventario('Producto1', 0);
...
use tpTransacciones;
	...
	DELIMITER //
	CREATE PROCEDURE RegistrarCompra (IN cuenta VARCHAR(50),IN monto DECIMAL(10,2)
	)
	begin
        ...
        insert into transacciones (numero_cuenta,monto) values (cuenta,monto);
			...
			rollback;
			select 'no tenes saldo';
		end if;
end //
	DELIMITER ;
    select * from cuentas_clientes;
    SELECT * FROM transacciones;
    CALL RegistrarCompra('cuenta3',200);